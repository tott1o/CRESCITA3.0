...
import poster14 from '../assets/poster-realeses/15.jpeg';
                ...
                <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 md:p-6">
                    ...
                    >
                        ...
                        <div className="p-6 md:p-8 bg-slate-900 w-full flex flex-col items-center">
                            ...
                            >
                                Registration is <span className="text-blue-400">LIVE!</span>
                            </motion.h2>
                            ...
                            >
                                Normal registration for CRESCITA 3.0 has started. Secure your spot now!
                            </motion.p>

                            <motion.div variants={itemVariants} className="flex flex-col gap-4 w-full items-center">
                                <button
                                    onClick={() => window.open('https://bit.ly/CRESICTA3registration', '_blank')}
                                    className="w-full sm:w-auto group px-6 py-3 md:px-7 md:py-3.5 bg-white text-slate-950 rounded-lg font-bold text-sm md:text-base hover:bg-blue-50 transition-all flex items-center justify-center gap-2 shadow-lg shadow-white/5"
                                >
                                    Register Now
...
export default NormalRegistrationPopup;
